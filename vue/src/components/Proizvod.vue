        ...
        <div class="pt-6">
          <nav aria-label="Breadcrumb">
            <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
              ...
              <li class="text-sm">
                <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">Naslov proizvoda</a>
              </li>
            </ol>
          </nav>
                ...
                <div class="mt-4">
                  <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                    <li class="text-gray-400">
                      <span class="text-gray-600">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium</span>
                    </li>
                    <li class="text-gray-400">
                      <span class="text-gray-600"
                        >doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto</span
                      >
                    </li>
                    <li class="text-gray-400"><span class="text-gray-600">beatae vitae dicta sunt explicabo</span></li>
                    <li class="text-gray-400">
                      <span class="text-gray-600">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit</span>
                    </li>
                  </ul>
                </div>
              </div>
